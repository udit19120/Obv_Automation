...
public class Exchange_New_Page_Test extends TestBase {
    ...
    public void FormTest1(String my_category, String my_make, String my_model, String my_trim, String  my_year, String my_kms_driven, String my_eMake, String my_eModel, String my_eTrim) {
//        exchange_new_page.newFillForm("1","BMW","X1","SDRIVE 20I SPORTX BS6","2021","1000","BMW","3 Series","M340I");
        exchange_new_page.newFillForm(my_category, my_make, my_model, my_trim, my_year, my_kms_driven, my_eMake, my_eModel, my_eTrim);
    }
