...
//        auto_link.click();
    ...
    public void newFillForm(String my_vehicle,String my_city, String auto_vehicle_in) throws InterruptedException {
        ...
        //  deliberately failed case: element will not be found
        String x_path_vehicle="//u[@id='newauto-suggest']//li[text()='"+ my_vehicle +"']";
