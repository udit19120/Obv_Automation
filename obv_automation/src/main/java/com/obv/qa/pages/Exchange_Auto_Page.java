...
public class Exchange_Auto_Page extends TestBase {
    ...
    public void newFillForm(String my_vehicle,String my_kms, String my_exc_vehicle, String auto_in_vehicle, String auto_in_exc_vehicle) throws InterruptedException {
