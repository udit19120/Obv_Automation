...
public class Future_Price_For_New_Page_Test extends TestBase {
    ...
    public void FormTest1(String my_category, String my_make, String my_model, String my_trim, String  my_year, String my_kms_driven) {
        future_price_for_new_page.newFillForm(my_category,my_make, my_model,my_trim,my_year,my_kms_driven);
    }
