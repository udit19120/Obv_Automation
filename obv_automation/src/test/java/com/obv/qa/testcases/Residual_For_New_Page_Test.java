...
public class Residual_For_New_Page_Test extends TestBase {
    ...
    public void FormTest1(String my_category, String my_make, String my_model, String my_trim, String  my_tenure, String my_kms_driven) {
//        residual_for_new_page.newFillForm("1","BMW","3 Series","M340I","1","1000");
        residual_for_new_page.newFillForm(my_category, my_make,my_model,my_trim,my_tenure,my_kms_driven);
    }
