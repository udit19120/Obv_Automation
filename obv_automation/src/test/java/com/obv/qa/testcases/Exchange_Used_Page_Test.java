...
public class Exchange_Used_Page_Test extends TestBase {
    ...
    public void FormTest1(String my_category, String my_make, String my_model, String my_trim, String my_year, String my_kms_driven, String my_eMake, String my_eModel, String my_eYear, String my_eTrim, String my_eKms) {
//        exchange_used_page.newFillForm("1","BMW","X1","SDRIVE 20I SPORTX BS6","2021","1000","BMW","3 Series","2022","M340I","1000");
        exchange_used_page.newFillForm(my_category, my_make, my_model, my_trim, my_year, my_kms_driven, my_eMake, my_eModel, my_eYear, my_eTrim, my_eKms);
    }
